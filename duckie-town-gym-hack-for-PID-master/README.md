...
Install:
```
git clone https://github.com/JoRadiver/duckie-town-gym-hack-for-PID
```
i am not sure which directory the setup.py will be located on your machine. just run the pip3 install -e in the folder where the setup.py is.
```
cd duckie-town-gym-hack-for-PID
pip3 install -e .
```


To run :
execute the manual_control.py file with python.

To manipulate the values:
there is a PID class in the manual contol file.

Please do not distribute this code without reading the license of the underlying code in the original repo:
https://github.com/duckietown/gym-duckietown
My changes to the code are completly free to use.

The original Readme with installation instructions follows.
========================================================================================================================================================
# Gym-Duckietown
